...
export default function AnalysisView({
  ...
  // Set initial document type or show dropdown
  useEffect(() => {
  ...
  const saveToDB = async (data) => {
    ...
    try {
      // Prepare data for SYNM_DMS_DOC_CATG_QA
      const questionData = {
        REF_SERIAL_NO: -1, // Auto-generated by DB
      ...
      // Prepare data for SYNM_DMS_DOC_VALUES
      const answerData = {
        SERIAL_NO: -1, // Auto-generated by DB
        CATEGORY_NAME: selectedType,
        REF_KEY: data.REF_KEY,
